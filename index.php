        ...
        <div class="px-5 py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12">
                    ...
                    <p class="text-align-center px-3 py-1">
                        At the heart of an extensive ecosystem comprised of 20,000 technological companies,
                        nearly
                        2,000 digital start-ups, more than 40 business incubators and major tech events such as
                        Viva Technology, Wild Code School will train you to work as a web developer.
                    </p>

                    <p class="text-align-center px-3 py-1">Our digital school is located a short distance from
                        Station F, the world’s largest business
                        incubator. Wild Code School will enable you to learn computer programming in an innovative
                        way, by completing projects for real customers. After completing your web development
                        training in Paris, you will be able to work as a developer in a company based in Paris.
                    </p>
                    <!--texte-->
                </div>
            </div>
        ...
        <div class="justify-content-center m-5 d-flex flex-wrap card-columns">
            ...
            <div class="py-5">
                ...
                <div class="justify-content-center m-5 d-flex flex-wrap card-columns">
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row mx-3">
                                            <div class="col-sm-6">
                                                <!-- pictures -->
                                                <img class="card-img-top img-fluid mt-3" src="images/apple/pomme-or.jpg"
                                                     alt="Pomme Or">
                                            </div>
                                            <div class="col-sm-6">
                                                <!-- prices -->
                                                ...
                                                <!-- product description -->
                                                <p>Sa couleur or fera chaviré vos coeurs , cette élégance signé
                                                    "Pomme"
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="produit5" tabindex="-1" role="dialog" aria-labelledby="produit5"
                         aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row mx-3">
                                            <div class="col-sm-6">
                                                <!-- pictures -->
                                                <img class="card-img-top img-fluid mt-3" src="images/penguins/mug1.jpg"
                                                     alt="image du produit2">
                                            </div>
                                            <div class="col-sm-6">
                                                <!-- prices -->
                    ...
                    <div class="card">
                        <div data-toggle="modal" data-target="#produit3">
                            ...
                            <div class="card-body">
                                <!-- product description-->
                                <h4 class="card-title text-center">curvy windows</h4>
                            </div>
                        </div>
                    </div>
                    <!-- Modal -->
                    <div class="modal fade" id="produit3" tabindex="-1" role="dialog" aria-labelledby="produit3"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <!-- product title-->
                                    <h4 id="titreduproduit3">curvy windows</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        ...
                                        <div class="row mx-3">
                                            <div class="col-sm-6">
                                                <!-- pictures-->
                                                <img class="card-img-top img-fluid mt-3" src="images/windows/7.png"
                                                     alt="image du produit3">
                                            </div>
                                            <div class="col-sm-6">
                                                <!-- prices -->
